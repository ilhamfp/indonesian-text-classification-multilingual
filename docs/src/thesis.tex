...
\begin{document}
    ...
    %Basic configuration
    \title{Klasifikasi Teks Berbahasa Indonesia Menggunakan \textit{Multilingual Language Model} (Studi Kasus: Klasifikasi Ujaran Kebencian dan Analisis Sentimen)}
    \date{}
    \author{
